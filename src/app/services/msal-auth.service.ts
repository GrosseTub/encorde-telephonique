...
import { Person, Restaurant, Users } from './onmangeou.service';
...
export class MsalAuthService {
  ...
  private usersUrl = environment.apiEndpoint + "v1/users/";
  private _voted: boolean;
  private _usersVotedId: Users["_id"] = "0";
  ...
  private callMSGraph(theUrl, accessToken, callback) {
    ...
    //  self.httpClient.get<Users>(environment.apiEndpoint + "surveys/" + self.data.id + '/users/')
  ...
  public vote(users: Users["_id"], comment?: string) {
    let person: Person = {
      id: this.data.id,
...
//      this.httpClient.post<Person>(this.usersUrl + users + '/surveys/', person)
//        .subscribe(myPersonObserver)
  ...
  public get usersVotedId(): Users["_id"] {
    return this._usersVotedId;
  }
